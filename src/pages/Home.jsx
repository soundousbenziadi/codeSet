                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <motion.div
                                ...
                                className="block md:inline-block px-4 py-2 rounded-full mb-6 mx-auto md:mx-0 w-fit"
                            ...
                            <motion.div
                                ...
                                className="flex items-center space-x-6 mt-8 px-6 justify-center md:justify-start"
                            >
