...
const Home = () => {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 `}
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <motion.h1
                                ...
                                className="text-5xl md:text-7xl font-bold mb-6 leading-tight border-l-4 pl-6"
                                style={{ fontFamily: 'var(--font-heading)', borderColor: 'var(--color-accentc)' }}
                            >
                                Setifeian Programming
                            ...
                            >
                                Challenge yourself with algorithmic problems and CTF challenges.
                            ...
                            >
                                <motion.button
                                    ...
                                    className="px-8 py-4 rounded-lg font-semibold flex items-center space-x-2 text-black"
                                    style={{ backgroundColor: 'var(--color-accentc)' }}
                                >
            ...
            {/* Schedule Section */}
            <section id="schedule" className="py-20 px-4" style={{ backgroundColor: 'var(--color-section1)' }}>
            ...
            <section id="prizes" className="py-20 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            { place: '1st Place', icon: Trophy, label: 'Winner Trophy + Prize', scale: 1.1 },
                            { place: '2nd Place', icon: Award, label: 'Runner-up Trophy + Prize', scale: 1.0 },
                            { place: '3rd Place', icon: Award, label: 'Second Runner-up Trophy + Prize', scale: 1.0 }
                        ].map((prize, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 50 }}
                                ...
                                viewport={{ once: false, amount: 0.3 }}
                                transition={{ duration: 0.8, delay: idx * 0.2 }}
                                whileHover={{ scale: prize.scale, y: -10 }}
                                className="p-8 rounded-2xl text-center"
                                style={{
                                    backgroundColor: idx === 0 ? 'var(--color-accentc)' : 'var(--color-section2)',
                                    color: idx === 0 ? '#000' : 'var(--color-textc)'
                                }}
                            >
                                <prize.icon className="w-16 h-16 mx-auto mb-4"
                                    style={{ color: idx === 0 ? '#000' : 'var(--color-accentc)' }} />
                                <h3 className="text-2xl font-bold mb-2">{prize.place}</h3>
                                <p className="text-lg">{prize.label}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            {/* CTA Section */}
            <section className="py-20 px-4" style={{ backgroundColor: 'var(--color-section1)' }}>
            ...
            <footer className="py-8 px-4 border-t"
                style={{
                    backgroundColor: 'var(--color-primaryc)',
                        ...
                        {!submitted ? (
                            <>
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-3xl font-bold" style={{ fontFamily: 'var(--font-heading)' }}>
